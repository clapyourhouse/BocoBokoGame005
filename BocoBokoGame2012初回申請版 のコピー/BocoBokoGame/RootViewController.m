...
- (void)viewDidLoad {
    ...
    if (NSClassFromString(kADBannerViewClass) != nil) {
        ...
        self.bannerView = [[ADBannerView alloc] initWithFrame:CGRectMake(0.0, 367.0, 320.0, 50.0)];
        [self.bannerView setRequiredContentSizeIdentifiers:[NSSet setWithObjects:
                                                            ADBannerContentSizeIdentifierPortrait,
                                                            ADBannerContentSizeIdentifierLandscape, nil]];
        
        self.bannerView.currentContentSizeIdentifier = ADBannerContentSizeIdentifierPortrait;
        // bannerView.frame = CGRectOffset(bannerView.frame, 0, screenRect.size.height -50);
...
- (void)moveBannerViewOnscreen{
	CGRect newBannerView = self.view.frame;
	newBannerView.origin.y = self.view.frame.size.height - self.bannerView.frame.size.height;
